...
export function useProject(projectId: string) {
  ...
  async function addTask(input: { title: string; summary?: string; context?: string; acceptance_criteria?: string; group_key?: string; status?: string; effort?: string; impact?: string; category?: string }) {
    if (!project) return;
