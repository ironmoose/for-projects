/**
 * Global keyframe injector. Uses useInjectStyles to inject all shared
 * animation keyframes into <head> once, deduplicated by ID.
 * Respects prefers-reduced-motion.
 *
 * Rendered once at the app root in App.tsx. Returns null — style injection
 * is handled by the hook, not by rendering a <style> element.
 */
...
export function AnimationStyles() {
  useInjectStyles("tfp-animations", ANIMATION_CSS);
  return null;
}
